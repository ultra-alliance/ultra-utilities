import getFactoryDetail from './index';
...
describe('getFactoryDetail', () => {
  ...
  it('should call getFactoryDetail with the correct arguments', async () => {
    ...
    const result = await getFactoryDetail({ factoryId, bpApiEndpoint });
  ...
  it('should return an error if rows length == 0', async () => {
    ...
    await expect(
      getFactoryDetail({ factoryId: 1, bpApiEndpoint }),
